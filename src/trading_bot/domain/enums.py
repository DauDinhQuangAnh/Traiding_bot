...
class ExitReason(StrEnum):
    ...
    MULTI_TARGET_COMPLETE = "MULTI_TARGET_COMPLETE"
...
@unique
class BacktestFailureKind(StrEnum):
...
@unique
class BacktestEntryFillPolicy(StrEnum):
    NEXT_M5_OPEN = "NEXT_M5_OPEN"
...
@unique
class BacktestLimitFillPolicy(StrEnum):
    ASSUMED_FULL_FILL = "ASSUMED_FULL_FILL"


@unique
class GapStopPolicy(StrEnum):
    OPEN_OR_STOP_WORSE = "OPEN_OR_STOP_WORSE"


@unique
class TargetGapPolicy(StrEnum):
    TARGET_PRICE_NO_IMPROVEMENT = "TARGET_PRICE_NO_IMPROVEMENT"
...
class EndOfBacktestPolicy(StrEnum):
    FORCE_CLOSE_AT_FINAL_AVAILABLE_MARK = "FORCE_CLOSE_AT_FINAL_AVAILABLE_MARK"
...
class BacktestEventType(StrEnum):
    ...
    ECONOMIC_HALT = "ECONOMIC_HALT"
    BACKTEST_HALTED = "BACKTEST_HALTED"
    BACKTEST_COMPLETED = "BACKTEST_COMPLETED"
    BACKTEST_FAILED = "BACKTEST_FAILED"


@unique
class BacktestWarning(StrEnum):
    MODELED_SPREAD = "MODELED_SPREAD"
    MODELED_SLIPPAGE = "MODELED_SLIPPAGE"
    NO_REAL_ORDERBOOK = "NO_REAL_ORDERBOOK"
    NO_LIQUIDATION_MODEL = "NO_LIQUIDATION_MODEL"
    FUNDING_DISABLED = "FUNDING_DISABLED"
    FULL_LIMIT_FILL_ASSUMPTION = "FULL_LIMIT_FILL_ASSUMPTION"
    NEGATIVE_EQUITY_WITHOUT_LIQUIDATION_MODEL = "NEGATIVE_EQUITY_WITHOUT_LIQUIDATION_MODEL"
